...
-- Dumping structure for table app.mahasiswa
...
-- Dumping data for table app.mahasiswa: ~1 rows (approximately)
/*!40000 ALTER TABLE `mahasiswa` DISABLE KEYS */;
INSERT INTO `mahasiswa` (`nim`, `nama`, `jurusan`, `alamat`) VALUES
	(18090022, 'Evi Susilowati', 'Teknik Informatika', 'Randusari');
